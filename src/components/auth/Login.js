    ...
    <div className=" popup-container flex justify-center items-center">
      <div className="w-3/4 mx-auto">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
           <Link to="/verify-otp">
           <p className="text-xs text-start mt-4 ">By signin, you agree to the <span className="font-mono" style={{color:'#E2136E'}}>Terms and Condions</span></p></Link>
          </div>
          <div>
            {isLoading ? (
          ...
          <div>
           <Link to="/register">
           <p className="text-xs text-start mt-2 ">Don't have an account<span className=" font-mono ml-2"  style={{color:'#E2136E'}}>Create an account</span></p></Link>
          </div>
        </form>
      </div>
    </div>
